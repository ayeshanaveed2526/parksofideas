...
export default function Herosection() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-white">
      ...
      <a 
        href="#"
        className="fixed right-0 top-1/2 z-50 -translate-y-1/2 transition-transform duration-300 origin-right scale-75 md:scale-100 hover:scale-90 md:hover:scale-110"
