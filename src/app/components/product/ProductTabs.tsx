              ...
              <>
                ...
                >
                  <div className="w-full h-80 bg-gray-100 flex items-center justify-center relative overflow-hidden group hover-lift rounded-sm">
                     ...
                     <img src="/assets/images/products/elix-02.png" alt="Elysia Eau de Parfum" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
