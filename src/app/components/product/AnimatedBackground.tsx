...
const AnimatedBackground: React.FC = () => (
  <div
    ...
    style={{
      background: 'linear-gradient(145deg, #ffe6e4ff 0%, #f4e4dfff 35%, #e5f7f7ff 65%, #eaf3f4 100%)',
    }}
  >
    ...
    >
      ...
      <circle cx="8%" cy="15%" r="60" fill="none" stroke="rgba(205,174,159,0.12)" strokeWidth="1.5">
      ...
      <circle cx="85%" cy="70%" r="45" fill="none" stroke="rgba(205,174,159,0.10)" strokeWidth="1">
      ...
      <circle cx="50%" cy="85%" r="35" fill="rgba(205,174,159,0.04)" stroke="rgba(205,174,159,0.08)" strokeWidth="1">
        <animateTransform attributeName="transform" type="translate" values="0,0; 20,10; -10,-5; 0,0" dur="25s" repeatCount="indefinite" />
      </circle>

      {/* ── Rotating diamonds ── */}
      <rect x="75%" y="12%" width="40" height="40" fill="none" stroke="rgba(180,210,210,0.12)" strokeWidth="1" rx="3">
      ...
      <rect x="20%" y="60%" width="30" height="30" fill="none" stroke="rgba(205,174,159,0.09)" strokeWidth="1" rx="2">
      ...
      {/* ── Drifting hexagons ── */}
      <polygon points="30,0 60,17 60,52 30,70 0,52 0,17" fill="none" stroke="rgba(180,210,210,0.10)" strokeWidth="1" transform="translate(120, 280) scale(0.7)">
      ...
      <polygon points="30,0 60,17 60,52 30,70 0,52 0,17" fill="rgba(205,174,159,0.03)" stroke="rgba(205,174,159,0.08)" strokeWidth="1" transform="translate(900, 150) scale(0.55)">
      ...
      {/* ── Floating triangles ── */}
      <polygon points="25,0 50,45 0,45" fill="none" stroke="rgba(205,174,159,0.10)" strokeWidth="1" transform="translate(300, 80)">
      ...
      <polygon points="20,0 40,35 0,35" fill="none" stroke="rgba(180,210,210,0.08)" strokeWidth="1" transform="translate(700, 500)">
      ...
      {/* ── Gentle plus/cross shapes ── */}
      <g transform="translate(600, 100)" stroke="rgba(205,174,159,0.10)" strokeWidth="1.5" strokeLinecap="round">
      ...
      <g transform="translate(200, 450)" stroke="rgba(180,210,210,0.09)" strokeWidth="1.5" strokeLinecap="round">
      ...
      {/* ── Dotted ring ── */}
      <circle cx="45%" cy="40%" r="50" fill="none" stroke="rgba(205,174,159,0.07)" strokeWidth="1" strokeDasharray="4 8">
