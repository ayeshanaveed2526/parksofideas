      ...
      <div className="mx-auto flex w-full items-center justify-center px-4 xl:px-[120px]">
        ...
        >
          {categories.map((category, index) => (
            ...
            >
              <div className="flex h-[75px] w-[75px] sm:h-[80px] sm:w-[80px] md:h-[90px] md:w-[90px] lg:h-[104px] lg:w-[104px] shrink-0 items-center justify-center rounded-full bg-white overflow-hidden hover-ring-pulse hover-glow transition-all duration-300">
              ...
              <span
                className="flex w-full lg:w-[160px] items-center justify-center text-[#1a1a1a] transition-all duration-300 group-hover:text-[rgb(205,174,159)] group-hover:tracking-[0.28em] relative text-center uppercase font-normal tracking-[0.2em] leading-[1.26] pl-[0.2em] mt-[15px] lg:mt-[25px] text-[12px] lg:text-[14px]"
